...
<div class="fundo-desc">
    <div class="descricao">
        <div class="img-container">
            <img class="img-desc" src="{{ asset('images/conceito-de-engenharia-de-computador-plana.png') }}" alt="bbbbbb">
        </div>
    </div>
...
<div class="fundo-desc">
    <div class="descricao">
        <div class="img-container">
            <img class="img-desc" src="{{ asset('images/Wallpaper – Back-End II 1.png') }}" alt="bbbbbb">
        </div>
    </div>
