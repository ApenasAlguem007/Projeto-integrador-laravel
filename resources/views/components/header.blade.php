...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/Aurora-Logo-White.png')}}">
...
<nav class="navbar navbar-expand-lg navbar-dark px-3" style="background-color: #202020;">
  <div class="container-fluid" >
    <a class="navbar-brand" href="{{asset('index')}}">
      <img src="{{asset('images/Aurora-Logo-White.png')}}" alt="logo" height="105" width="105">
    </a>
