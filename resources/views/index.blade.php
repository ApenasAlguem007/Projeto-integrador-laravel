...
<div class="container-home">
 ...
 <img class="img-home"src="{{ asset('images/React-Native-Code-Image-(1)-1.png') }}">
</div>
...
<div class="corpo-home">
    ...
    <div>
        ...
        <div class="caixa-img">
         <img class="img-cursos" src="{{ asset('images/Wallpaper–Back-End-1.png') }}">
        </div>
        ...
        <div class="caixa-img">
         <img class="img-cursos" src="{{ asset('images/Wallpaper – Back-End II 1.png') }}">
        </div>
    </div>
</div>
</div>
